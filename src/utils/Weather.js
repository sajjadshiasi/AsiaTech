...
const API_URL_CURRENT = `https://api.openweathermap.org/data/2.5/weather?&lang=fa&appid=${API_KEY}&units=metric`;
...
const weatherApi = {
 ...
 async get3HoursData(city) {
  ...
  // React.useEffect(() => {
  //   const id = setInterval(get3HoursData, 60000);
